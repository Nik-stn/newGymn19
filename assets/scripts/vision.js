...
const buttons = document.querySelectorAll(".vision-alt, .vision-alt .header-nav-pc .parent>a, .announcement-news .ajax__tab_header, .announcement-news .ajax__tab_header>span.ajax__tab_active .ajax__tab_tab, .header-mobile .level_0, .show-hide");
